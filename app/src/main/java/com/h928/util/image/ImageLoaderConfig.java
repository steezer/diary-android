...
public class ImageLoaderConfig {
	...
	public static DisplayImageOptions initDisplayOptions(boolean isShowDefault) {
		...
		if (isShowDefault) {
			// 默认显示的图片
			displayImageOptionsBuilder.showStubImage(R.mipmap.ic_launcher);
			// 地址为空的默认显示图片
	...
	public static DisplayImageOptions initDisplayOptions(int targetWidth,boolean isShowDefault)
	{
		...
		if (isShowDefault) {
			...
			displayImageOptionsBuilder.showStubImage(R.mipmap.ic_launcher);
			// 地址为空的默认显示图片
			displayImageOptionsBuilder.showImageForEmptyUri(R.mipmap.ic_launcher);
			// 加载失败的显示图片
			displayImageOptionsBuilder.showImageOnFail(R.mipmap.ic_launcher);
		}
		// 开启内存缓存
