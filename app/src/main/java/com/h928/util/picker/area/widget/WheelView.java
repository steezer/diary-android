...
package com.h928.util.picker.area.widget;
...
import com.h928.util.picker.area.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xffE9E9E9,
			0xaaE9E9E9, 0x00E9E9E9 };
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xffE9E9E9,
			0xbbE9E9E9, 0x00E9E9E9 };
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.util_picker_area_wheel_bg;
	private int wheelForeground = R.drawable.util_picker_area_wheel_val;
